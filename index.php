...
$APPLICATION->SetTitle("Тест Сайта"); ?>

<!-- Slider Area -->
<section id="slider" class="slider" style="background-image:url('<?= SITE_TEMPLATE_PATH ?>/img/slider.jpg')">
	<div class="container">
		<div class="row">
			<div class="col-md-7 col-sm-12 col-xs-12">
				<div class="text">
					<h1>Hi,my name is X-man</h1>
			...
			<div class="about-content">
				...
				<div class="col-md-6  col-sm-6 col-xs-12">
					<div class="single-about">
						<p class="bolt">Hello!, I'm Akhtar Hossain, User experience designer based in Pekanbaru.</p>
						<p>Lorem Ipsum Dolor Sit Amet, Consectetur Adipisicing Elit. Hic Laboriosam Ipsa Sequi? Laudantium Aspernatur Iusto Blanditiis, Totam Perferendis Dicta Magni.Lorem Ipsum Dolor Sit Amet, Consectetur Adipisicing Elit.Laudantium Aspernatur Iusto Blanditiis, Totam Perferendis Dicta Magni.Lorem Ipsum Dolor Sit Amet,</p>
						<p class="bolt">"Proin adipiscing porta tellus, ut feugiat nibh adipiscing sit amet. In eu justo a felis faucibus ornare vel id metus. Vestibulum ante ipsum primis".</p>
						<div class="cv">
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="image">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/about.jpg" alt="#">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="skill-content">
								...
								<p><b>Hello!, I'm Akhtar Hossain, User experience designer based in Pekanbaru.</b></p>
								<p>Lorem Ipsum Dolor Sit Amet, Consectetur Adipisicing Elit. Hic Laboriosam Ipsa Sequi? Laudantium Aspernatur Iusto Blanditiis, Totam Perferendis Dicta Magni.Lorem Ipsum Dolor Sit Amet, Consectetur Adipisicing Elit.Laudantium Aspernatur Iusto Blanditiis, Totam Perferendis Dicta Magni.Lorem Ipsum Dolor Sit Amet,</p>
								<p><b>"Proin adipiscing porta tellus, ut feugiat nibh adipiscing sit amet. In eu justo a felis faucibus ornare vel id metus.</b></p>
							</div>
						</div>
						<div class="col-md-6 col-sm-12 col-xs-12">
			...
			<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
				<div class="story-content">
					...
					<div class="single-story">
						<span class="year wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.4s">2015</span>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="works-menu wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
					<ul>
						...
						<li data-filter=".wordpress"><i class="fa fa-life-ring"></i>SEO Marketing</li>
					</ul>
				</div>
				<!--/ End Project Nav -->
			</div>
			...
			<div class="isotop-active">
				<div class="col-md-4 col-sm-4 col-xs-12 print identity">
					...
					<div class="single-work">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/pf1.jpg" alt="#">
						<div class="works-hover">
							<h4><a href="pf-2colum.html">WEB DEVELOPMENT</a></h4>
							<div class="link"></div>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12 wordpress branding">
					<!-- single-work -->
					<div class="single-work">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/pf2.jpg" alt="">
						<div class="works-hover">
							<h4><a href="pf-2colum.html">Wordpress</a></h4>
							<div class="link"></div>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12 web">
					<!-- single-work -->
					<div class="single-work">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/pf3.jpg" alt="">
						<div class="works-hover">
							<h4><a href="pf-2colum.html">App Development</a></h4>
							<div class="link"></div>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12  wordpress">
					<!-- single-work -->
					<div class="single-work">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/pf4.jpg" alt="">
						<div class="works-hover">
							<h4><a href="pf-2colum.html">WEB DEVELOPMENT</a></h4>
							<div class="link"></div>
						</div>
				...
				<div class="col-md-4 col-sm-4 col-xs-12  branding">
					<!-- single-work -->
					<div class="single-work">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/pf5.jpg" alt="">
						<div class="works-hover">
							<h4><a href="pf-2colum.html">Photography</a></h4>
							<div class="link"></div>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12  branding">
					<!-- single-work -->
					<div class="single-work">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/pf6.jpg" alt="">
						<div class="works-hover">
							<h4><a href="pf-2colum.html">SEO Marketing</a></h4>
							<div class="link"></div>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12 web print">
					<!-- single-work -->
					<div class="single-work">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/pf7.jpg" alt="">
						<div class="works-hover">
							<h4><a href="pf-2colum.html">Photography</a></h4>
							<div class="link"></div>
						</div>
				...
				<div class="col-md-4 col-sm-4 col-xs-12 web print">
					<!-- single-work -->
					<div class="single-work">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/pf8.jpg" alt="">
						<div class="works-hover">
							<h4><a href="pf-2colum.html">App Development</a></h4>
							<div class="link"><a href="portfolio-single.html"></a></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="testi-content">
					...
					<div class="owl-carousel testimonial-slider">
						...
						<div class="single-testimonial">
							<img src="<?= SITE_TEMPLATE_PATH ?>/img/author1.jpg" alt="#">
						...
						<!--Start single-testimonial -->
						<div class="single-testimonial">
							<img src="<?= SITE_TEMPLATE_PATH ?>/img/author2.jpg" alt="#">
							<p><i class="fa fa-quote-left"></i><i>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </i> </p>
							<div class="star">
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
			...
			<div class="col-md-4 col-sm-12 col-xs-12 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.4s">
				<div class="single-news">
					<div class="news-head">
						...
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/blog1.jpg" alt="#">
						<div class="news-view">
			...
			<div class="col-md-4 col-sm-12 col-xs-12 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.4s">
				<div class="single-news">
					<div class="news-head">
						...
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/blog2.jpg" alt="#">
						<div class="news-view">
							<span><i class="fa fa-comments"></i>25 comments</span>
							<span><i class="fa fa-eye"></i>10k views</span>
						</div>
...
<!-- <div class="single-news">
	<div class="news-head">
		...
		<img src="<?= SITE_TEMPLATE_PATH ?>/img/blog3.jpg" alt="#">
		<div class="news-view">
			<span><i class="fa fa-comments"></i>25 comments</span>
			<span><i class="fa fa-eye"></i>10k views</span>
		</div>
		...
		<div class="row">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="contact-info">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					<span><i class="fa fa-phone-square"></i>+262 695 2601</span>
					<span><i class="fa fa-map-marker"></i>121 King Street, Australia</span>
					<span><i class="fa fa-envelope"></i><a href="#">youmail@gmail.com</a></span>
					<span><i class="fa fa-globe"></i><a href="#">www.yourWebside.com</a></span>
				</div>
			</div>
			<div class="col-md-8 col-sm-12 col-xs-12 ">
				<div class="form-head">
			...
			<div class="col-md-12">
				<div class="owl-carousel clients-slider">
					<div class="single-clients">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/brand-1.png" alt="#">
					</div>
					<div class="single-clients">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/brand-2.png" alt="#">
					</div>
					<div class="single-clients">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/brand-3.png" alt="#">
					</div>
					<div class="single-clients">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/brand-4.png" alt="#">
					</div>
					<div class="single-clients">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/brand-5.png" alt="#">
					</div>
					<div class="single-clients">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/brand-6.png" alt="#">
					</div>
					<div class="single-clients">
						<img src="<?= SITE_TEMPLATE_PATH ?>/img/brand-1.png" alt="#">
					</div>
